    ...
    <footer >
        ...
        <div class="footer-section container text-left" >   
            <div style="margin-bottom: 15px;font-size:15px">
				...
				<div class="inline_mar-right" style="float:right">© Legistify <?php echo date("Y");?></div> 
            </div>
					...
					<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> <div class="modal-dialog">
					 <div class="modal-content">
					  <div class="modal-header" align="center"> 
					   <a class="light" href="#"><img src="assets/img/logo.png" height="35" width="35">
					   </div>
						<div class="modal-body" style="text-align:center;">
						<h2>We're Almost There!</h2>
						<div style="font-size:18px;">
						 Our team is working round the clock to get this feature ready.Stay tuned!
						 </div>
						</div> 
						<div class="modal-footer" align="center">
						<div align="center">
						 <button class="btn btn-dark" data-dismiss="modal">Ok </button>
						</div>  
						</div>
					   </div><!-- /.modal-content -->
					 </div><!-- /.modal -->
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.show_foot_links').click(function(){
                var col = $(this).parent().find('.links_collapse');
                if(col.hasClass('links_show')){
                    col.removeClass('links_show');
                    $(this).text('Show More');
                }
                else{
                    col.addClass('links_show');
                    $(this).text('Show Less');
                }
            });
        });
